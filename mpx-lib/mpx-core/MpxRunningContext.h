...
/*! I/O multiplexer starter function
 *
...
/*! I/O multiplexer time hook function
 *
...
private:
	...
	{
	public:
		/*!  create an instance of I/O handler
		 *
	...
	{
		/*! 'less than' relation on timer values
		 *
	...
	public:
		...
		/*! remove signal handler from linked list
		 *
...
public:
	...
	/*! reference to next signal handler
	 *
...
public:
	...
	/*! change I/O call-back function of I/O handler
	 *
