...
public:
	inline static void decSessionCount () { --m_sessionCount; }
	inline static void decSftpCount () { --m_sftpCount; }
	inline static void decFdCount () { --m_fdCount; }
	inline static void decDdCount () { --m_ddCount; }

	inline static int sessionCount () { return m_sessionCount; }
	inline static int sftpCount() { return m_sftpCount; }
	inline static int fdCount() { return m_fdCount; }
	inline static int ddCount() { return m_ddCount; }
...
private:
	...
	static int m_sftpCount;
	static int m_fdCount;
	static int m_ddCount;
